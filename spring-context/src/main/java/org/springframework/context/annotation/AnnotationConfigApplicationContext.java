...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	// AnnotatedBeanDefinition读取器 ：读取加注解类，将类转化为bd；构造方法中实例化
	...
	public AnnotationConfigApplicationContext(Class<?>... componentClasses) {
		// 先调用父类GenericApplicationContext的构造方法，初始化DefaultListableBeanFactory
		// 自己构造方法初始化 读取器（AnnotatedBeanDefinitionReader）和 扫描器（ClassPathBeanDefinitionScanner）
		this();
	...
	/**
	 * 注册单个Bean到容器，注册后需要手动调用refresh()方法
	 * 可以注册 配置类 和 单独一个类
